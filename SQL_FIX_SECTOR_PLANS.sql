-- ═══════════════════════════════════════════════════════════════════════════════
-- FIX: Drop and recreate all sector plan tables with correct column names
...
CREATE TABLE annual_carraa_plan_wereda_2 (LIKE annual_carraa_plan_wereda_1 INCLUDING ALL);
CREATE TABLE annual_carraa_plan_wereda_3 (LIKE annual_carraa_plan_wereda_1 INCLUDING ALL);
CREATE TABLE annual_carraa_plan_wereda_4 (LIKE annual_carraa_plan_wereda_1 INCLUDING ALL);

-- Fix the identity sequence for the cloned tables
ALTER TABLE annual_carraa_plan_wereda_2 ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY;
ALTER TABLE annual_carraa_plan_wereda_3 ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY;
ALTER TABLE annual_carraa_plan_wereda_4 ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY;
