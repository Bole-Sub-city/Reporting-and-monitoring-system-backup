    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        {WOREDAS.map((w) => (
          <div
            key={w.id}
            className="bg-white rounded-2xl border border-gray-200 shadow-sm px-5 py-4 flex flex-col items-center text-center"
          >
            <div
              className="w-10 h-10 rounded-full flex items-center justify-center mb-2 text-white"
              style={{
                background: "linear-gradient(135deg,#1e1456 0%,#2d1f7a 100%)",
              }}
            >
              <BuildingIcon />
            </div>
      ...
      {hasPlan ? (
        ...
        <div className="bg-white rounded-2xl border border-gray-200 px-6 py-10 flex flex-col items-center text-center shadow-sm">
          ...
          <p className="text-gray-400 text-sm max-w-xs">
            Go to Annual Plan to enter your subcity targets. They will be split
            across all 4 woredas automatically.
          </p>
        </div>
      )}
    </div>
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-0.5">
          Enter subcity totals and woreda weights. The system distributes
          proportionally.
        </p>
      </div>
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-0.5">
          Select a woreda to view its submitted reports.
        </p>
      </div>
          ...
          <button
            ...
            style={
              activeWoreda === w.id
                ? {
                    background:
                      "linear-gradient(90deg,#1e1456 0%,#2d1f7a 100%)",
                  }
                : {}
            }
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
          {PLAN_FIELDS.map(({ key, label, color }) => {
            ...
            return (
              <div
                key={key}
                className="bg-white rounded-2xl border border-gray-200 shadow-sm px-4 py-4"
              >
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-12 flex flex-col items-center text-center">
          ...
          <p className="text-gray-400 text-sm max-w-sm">
            The backend endpoint for fetching per-woreda reports hasn't been
            connected yet. Once available, wire it to{" "}
